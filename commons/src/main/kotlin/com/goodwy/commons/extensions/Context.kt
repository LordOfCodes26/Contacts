...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.android.contacts") && !packageName.startsWith("com.goodwy.dialer")) {
        true
    } else if ((packageName.startsWith("com.android.contacts") || packageName.startsWith("com.goodwy.dialer")) && isQPlus()) {
